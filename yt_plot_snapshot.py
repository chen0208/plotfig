...
Sx=yt.SlicePlot(ds, "z", ("gas", "density"))
...
#Sx.hide_colorbar()
Sx.save()
#px = yt.ProjectionPlot(ds, "x", ("PartType0", "density"), center=center)
#plot = px.plots["PartType0","density"]
#colorbar = plot.cb
#px._setup_plots()
#colorbar.set_ticks([0,0.1,1,10,100])
#colorbar.set_ticklabels(["0","$10^{-1}$","$10^{0}$","$10^{1}$","$10^{1}$"])
#px.save()
